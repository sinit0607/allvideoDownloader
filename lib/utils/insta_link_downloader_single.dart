...
//
//     final instaLinkDownloaderSingle = instaLinkDownloaderSingleFromJson(jsonString);

import 'dart:convert';

InstaLinkDownloaderSingle instaLinkDownloaderSingleFromJson(String str) =>
    InstaLinkDownloaderSingle.fromJson(json.decode(str));

String instaLinkDownloaderSingleToJson(InstaLinkDownloaderSingle data) =>
    json.encode(data.toJson());

class InstaLinkDownloaderSingle {
  InstaLinkDownloaderSingle({
    this.graphql,
  });

  Graphql? graphql;

  factory InstaLinkDownloaderSingle.fromJson(Map<String, dynamic> json) =>
      InstaLinkDownloaderSingle(
...
class ShortcodeMedia {
  ...
  factory ShortcodeMedia.fromJson(Map<String, dynamic> json) => ShortcodeMedia(
        ...
        edgeMediaToParentComment: EdgeMediaToParentCommentClass.fromJson(
...
class EdgeMediaPreview {
  ...
  factory EdgeMediaPreview.fromJson(Map<String, dynamic> json) =>
      EdgeMediaPreview(
        count: json["count"],
        edges: List<EdgeMediaPreviewCommentEdge>.from(
            json["edges"].map((x) => EdgeMediaPreviewCommentEdge.fromJson(x))),
      );
...
class EdgeMediaToParentCommentClass {
  ...
  factory EdgeMediaToParentCommentClass.fromJson(Map<String, dynamic> json) =>
      EdgeMediaToParentCommentClass(
        count: json["count"],
...
class PurpleNode {
  ...
  factory PurpleNode.fromJson(Map<String, dynamic> json) => PurpleNode(
        ...
        edgeThreadedComments: json["edge_threaded_comments"] == null
            ? null
            : EdgeMediaToParentCommentClass.fromJson(
  ...
  Map<String, dynamic> toJson() => {
        ...
        "edge_threaded_comments": edgeThreadedComments == null
            ? null
            : edgeThreadedComments!.toJson(),
      };
}
...
class EdgeMediaPreviewCommentEdge {
  ...
  factory EdgeMediaPreviewCommentEdge.fromJson(Map<String, dynamic> json) =>
      EdgeMediaPreviewCommentEdge(
...
class ShortcodeMediaOwner {
  ...
  factory ShortcodeMediaOwner.fromJson(Map<String, dynamic> json) =>
      ShortcodeMediaOwner(
        id: json["id"],
