...
//
//     final instaLinkDownloader = instaLinkDownloaderFromJson(jsonString);

import 'dart:convert';

InstaLinkDownloader instaLinkDownloaderFromJson(String str) =>
    InstaLinkDownloader.fromJson(json.decode(str));

String instaLinkDownloaderToJson(InstaLinkDownloader data) =>
    json.encode(data.toJson());

class InstaLinkDownloader {
  InstaLinkDownloader({
    this.graphql,
  });
  ...
  factory InstaLinkDownloader.fromJson(Map<String, dynamic> json) =>
      InstaLinkDownloader(
